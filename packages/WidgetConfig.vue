        ...
        <el-collapse-item name="1"
          ...
          <el-form-item label="是否必填">
            ...
            <!-- <el-input v-if="data.required"
                      v-model.lazy="data.patternNameKey"
                    ...
                    <el-form-item 
                        label="正则表达式"
                        label-width="110px">
            <el-select v-model="data.patternNameKey"
                       placeholder="正则表达式"
                       clearable>
              <el-option label="无限制"
...
export default {
  ...
  watch: {
    ...
    'data.patternNameKey'(val) {

      let curCkConf = validatorConfig[val]

      this.data.pattern = curCkConf.pattern

      if (val) this.validator.pattern = { pattern: new RegExp(val), message: `${this.data.label}格式不匹配`,...curCkConf }
